        ...
        <div class="bg-white px-7 py-5 rounded-md w-1/3">
            ...
            <form action="{{ route('login.process') }}" method="POST">
                ...
                <div class="flex flex-col mb-3">
                    ...
                    <input class="px-2 py-1 rounded-sm border-b border-black focus:outline-none" type="email" name="email"
                        required>
                    @if ($errors->has('email'))
                ...
                <button type="submit"
                    class="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white hover:bg-blue-600 w-full py-2 rounded-md mt-5 mb-3">Login</button>
                <p class="text-center text-sm">Don't have account? <a href="{{ route('register') }}"
                        class="text-blue-700 hover:text-blue-800">Register
                        here</a></p>
            </form>
        </div>
    </div>
